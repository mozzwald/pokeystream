...
LIB_S   = src/atari/pokeystream_atari.s src/atari/pokeystream_isr.s src/atari/pokeystream_buffers.s src/atari/pokeyserial_core.s
EX_C    = examples/atari_chat/atari_chat.c

OBJ     = src/atari/pokeystream_atari.o src/atari/pokeystream_isr.o src/atari/pokeystream_buffers.o src/atari/pokeyserial_core.o src/atari/pokeyserial.o examples/atari_chat/atari_chat.o
